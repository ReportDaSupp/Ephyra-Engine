...
namespace Engine {
    ...
    public:
        ...
        virtual uint32_t ApplyRetroGradeEffect(uint32_t sceneTexture, float frameCount) override;
    ...
    private:
        ...
        std::shared_ptr<Texture> RetroGradeColorTexture;
        ...
        std::shared_ptr<Shader> RetroGradeShaderProgram;
        ...
        void LoadRetroGradeShader(const char* shaderSource);
