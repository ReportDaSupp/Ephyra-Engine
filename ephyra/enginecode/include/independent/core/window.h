/**
 * \file window.h
 * \brief Contains the declaration of windowProperties Struct and the Window Class.
 */
#pragma once
...
{
	/** \struct Window
	* \brief holds the properties for the window class
	*/
	...
	struct WindowProperties
	{
		...
		WindowProperties(char * title = "My Window", uint32_t width = 1024, uint32_t height = 800, bool fullscreen = false) : m_title(title), m_width(width), m_height(height), m_isFullscreen(fullscreen) {}
	};
