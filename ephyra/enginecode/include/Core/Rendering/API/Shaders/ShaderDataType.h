...
namespace Engine
{
	...
	{
		None = 0, FlatByte, FlatInt, Short, Short2, Short3, Short4, Float, Float2, Float3, Float4, Byte4, Mat3, Mat4, Light, Vec2, Vec3, Vec4, Int, Int4
	...
	namespace SDT
	{
		...
		static uint32_t std140alignment(ShaderDataType type)
		{
			...
			case (ShaderDataType::Float4): return 4 * 4;
			case (ShaderDataType::Byte4): return 4 * 4;
			case (ShaderDataType::Mat3): return 4 * 3 * 3;
			case (ShaderDataType::Mat4): return 4 * 4 * 4;
			case (ShaderDataType::Vec2): return 4 * 2;
			case (ShaderDataType::Vec3): return 4 * 4;
			case (ShaderDataType::Vec4): return 4 * 4;
			default: return 0;
			}
		}
